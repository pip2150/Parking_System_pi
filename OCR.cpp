...
void OCR::readTraindata(string fn) {
	...
	switch (SAMPLESIZE) {
	case 5:
		fs["TrainingDataF5"] >> trainingData; break;
	case 10:
		fs["TrainingDataF10"] >> trainingData; break;
	case 15:
		fs["trainingdataf15"] >> trainingData; break;
	case 20:
		//fs["TrainingDataF20"] >> trainingData; break;
		fs["TrainingData"] >> trainingData; break;
	default:
		cerr << "Long SAMPLESIZE" << endl;
	}
	fs["classes"] >> classes;
